...
You will be given a writing sample. Describe its FORM: sentence rhythm, \
structure, register, and habits of expression.

Critical: your description must contain no subject matter. Do not name topics, \
facts, terms, or examples from the sample. A reader of your description must \
learn nothing about what the sample was about. Describe the container, never \
the contents.

For signature_habits, give observable formatting and phrasing patterns — \
"opens with a one-line definition before elaborating", "uses short sentence \
fragments for emphasis" — not the subject those habits were applied to."""
...
class StyleProfile(BaseModel):
    ...
    summary: str = Field(
        description="Two sentences on how this person writes. Form only."
    )
